...
from maad.sound import median_equalizer, smooth, spectrogram
...
class ROIDetector:
    ...
    def get_df_rois(self, ext, Sxx_db_noNoise_smooth, tn, fn):
        ...
        self.rois = format_features(df_rois, tn, fn).to_dict("records")
