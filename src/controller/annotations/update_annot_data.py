...
df_annot_excel = pd.read_excel('/Users/Paul/Paul/Desktop/My_projects/Bioacoustics/Maputo_Dash/datasets/tables/annot1.xlsx',1)
df_annot_excel.to_csv('/Users/Paul/Paul/Desktop/My_projects/Bioacoustics/Maputo_Dash/datasets/tables/annot1.csv')
...
def get_and_clean_new_annot_data():
    ...
    for file in filelist[:2]:
        ...
        if len(df_roi_annot)>0:
            ...
            df_rois_shape = df_rois_shape.append(df_rois_shape_temp.reset_index(drop=True),ignore_index=True)
            ...
            df_annot_final = pd.concat([df_annot_final,df_rois_all_features_temp,df_rois_shape],axis=0)
        else:
