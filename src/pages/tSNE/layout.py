                            ...
                            [
                                html.Div(
                                    [
                                        ...
                                        html.H5(
                                            [
                                                "t-distributed Stochastic Neighbor Embedding (t-SNE) of ROI"
                                            ],
...
def generate_graphs(
    n, features_options, perplexity, color, early_exag, learning_rate, n_iter, method
):
    if n == 0:
        raise PreventUpdate

    fig2 = compute_tSNE_2d(
        df_ROI_final,
